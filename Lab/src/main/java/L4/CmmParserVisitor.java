...
public interface CmmParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code extDefnorm}
	 * labeled alternative in {@link CmmParser#extDef}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExtDefnorm(CmmParser.ExtDefnormContext ctx);
	/**
	 * Visit a parse tree produced by the {@code extDeffun}
	 * labeled alternative in {@link CmmParser#extDef}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExtDeffun(CmmParser.ExtDeffunContext ctx);
	/**
