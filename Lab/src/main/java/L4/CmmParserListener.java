...
public interface CmmParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code extDefnorm}
	 * labeled alternative in {@link CmmParser#extDef}.
	 * @param ctx the parse tree
	 */
	void enterExtDefnorm(CmmParser.ExtDefnormContext ctx);
	/**
	 * Exit a parse tree produced by the {@code extDefnorm}
	 * labeled alternative in {@link CmmParser#extDef}.
	 * @param ctx the parse tree
	 */
	void exitExtDefnorm(CmmParser.ExtDefnormContext ctx);
	/**
	 * Enter a parse tree produced by the {@code extDeffun}
	 * labeled alternative in {@link CmmParser#extDef}.
	 * @param ctx the parse tree
	 */
	void enterExtDeffun(CmmParser.ExtDeffunContext ctx);
	/**
	 * Exit a parse tree produced by the {@code extDeffun}
	 * labeled alternative in {@link CmmParser#extDef}.
	 * @param ctx the parse tree
	 */
	void exitExtDeffun(CmmParser.ExtDeffunContext ctx);
	/**
